...
const FeatureItem = ({ title, description, icon: Icon, delay, children }: { title: string, description: string, icon: React.ElementType, delay: number, children?: React.ReactNode }) => {
  return (
    <motion.div 
        ...
        >
           <div className="w-full h-48 bg-black border border-white/20 rounded-xl relative overflow-hidden flex flex-col">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                 <div className="w-full h-[1px] bg-accent/50 box-shadow-[0_0_10px_rgba(243,253,83,0.5)]"></div>
              </div>
           </div>
        </FeatureItem>
          ...
          <div className="w-full h-48 flex items-center justify-center">
            <div className="bg-gray-900 border border-white/10 rounded-xl p-4 w-full max-w-[240px] shadow-2xl">
               <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-[10px] text-gray-500 ml-auto">0:10</span>
               </div>
               <p className="text-xs text-gray-300">動画の準備ができました！</p>
               <p className="text-[10px] text-gray-500 mt-1">昨日の思い出を見返しましょう。</p>
            </div>
          </div>
        </FeatureItem>
        ...
        >
           <div className="w-full h-48 flex items-center justify-center relative">
              <div className="text-center">
                 <span className="text-5xl font-bold text-accent glow-text">1</span>
